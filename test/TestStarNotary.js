...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar('Beautiful Star!', tokenId, {from: user1});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Happy Star!', tokenId1, {from: user1});
    await instance.createStar('Cute Star!', tokenId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar('Grteful Star!', tokenId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    await instance.createStar('Deligthful Star!', tokenId, {from: user});

    // 2. Call your method lookUptokenIdToStarInfo
    let starName = await instance.lookUptokenIdToStarInfo.call(tokenId);

    // 3. Verify if you Star name is the same
    assert.equal(starName, 'Deligthful Star!');
});